...
#define TEXTURE       "dragonskingold" // wood2 dragonskingold
...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        tex_color_floor = loadTexture2D("../Modele/" TEXTURE_FLOOR ".jpg");
...
void WidgetOpenGL::paintScene(boolean gen_shadow_map)
{
    ...
    if (!gen_shadow_map)
    {
        Material material(1.0,      1.0,      1.0,        0.2, // ambient
