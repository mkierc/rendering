...
private slots:
    ...
    void on_verticalSliderTexSize_valueChanged(int value);
    void on_verticalSliderTexNoiseFactor_valueChanged(int value);
    void on_verticalSliderTexNoiseDens_valueChanged(int value);
    void on_verticalSliderTexPow_valueChanged(int value);

    void on_pushButtonMarble_clicked();

    void on_pushButtonWood_clicked();

    void on_verticalSliderTexNoiseFractal_valueChanged(int value);
