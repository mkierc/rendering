...
#define MODEL_SHADOW  "texcube"
#define MODEL_FLOOR   "plane"
#define TEXTURE       "wood2"   // wood2 dragonskingold wood2x
#define TEXTURE_FLOOR "stones2"  // stones2 bricks
#define GAUSS_CNT     5
...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        ////////////////////////////////////////////////////////////////
        // Vertex Buffer Object + Vertex Array Object (shadow)
        ////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
        // Vertex Buffer Object + Vertex Array Object (screen)
        ////////////////////////////////////////////////////////////////
        ...
        light.setColor(1.0, 1.0, 1.0, 25.0);
...
void WidgetOpenGL::paintScene(boolean gen_shadow_map)
{
    ...
    if (!gen_shadow_map)
    {
        int attr = getUniformLocation(prog, "focusDistance");
        glUniform1f(attr, focus_distance);
        attr = getUniformLocation(prog, "focusRange");
        glUniform1f(attr, focus_range);
    }
...
void WidgetOpenGL::set_focus(float distance, float range)
{
