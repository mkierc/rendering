...
//        glCullFace(GL_BACK);
        ...
        tessInner0 = tessInner1 = tessOuter0 = tessOuter1 = tessOuter2 = tessOuter3 = 4.0;
        bend = 0.0;
...
void WidgetOpenGL::paintGL()
{
    ...
    try
    {
        ...
        GLfloat square[6*4] = {-1.0,  -1.0, -bend,   1.0, 0.0, 0.0,
                               -1.0,   1.0,  bend,   0.0, 1.0, 0.0,
                                1.0,   1.0, -bend,   1.0, 1.0, 0.0,
                                1.0,  -1.0,  bend,   0.0, 0.0, 1.0
                              };


        glBindBuffer(GL_ARRAY_BUFFER, VBO);
        glBufferData(GL_ARRAY_BUFFER, 24*sizeof(GLfloat), square, GL_STATIC_DRAW);
        ...
        attr = getUniformLocation(shaderProgram, "tessInner0");
        glUniform1f(attr, tessInner0);

        attr = getUniformLocation(shaderProgram, "tessInner1");
        glUniform1f(attr, tessInner1);
        ...
        attr = getUniformLocation(shaderProgram, "tessOuter3");
        glUniform1f(attr, tessOuter3);
...
void WidgetOpenGL::set_tess(float tess_in0, float tess_in1, float tess_out0, float tess_out1, float tess_out2, float tess_out3)
{
    tessInner0 = tess_in0;
    tessInner1 = tess_in1;
    ...
    tessOuter3 = tess_out3;

    repaint();
}


void WidgetOpenGL::set_bend(float _bend)
{
    bend = _bend;
